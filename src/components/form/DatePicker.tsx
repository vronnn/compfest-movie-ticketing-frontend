            ...
            <div className={clsx('relative', withLabel && 'mt-1')}>
              <ReactDatePicker
                ...
                className={clsx(
                  ...
                  'min-h-[2.25rem] py-0 md:min-h-[2.5rem] px-4 text-base-dark',
                  'border-gray-300 focus:border-base-yellow focus:ring-base-yellow focus:outline-2 focus:outline-base-yellow',
                  (readOnly || disabled) &&
